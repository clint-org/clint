...
- [ ] Still as `aadi529@gmail.com`, on `stout.clintapp.com/admin/tenants`, provision tenant: name `Pfizer`, subdomain `pfizer`. Confirm it appears in the tenants list. `provision_tenant` auto-adds `aadi529@gmail.com` as both tenant owner and Workspace space owner.
