...
Stout's primary analytical work product, attached to entities in an engagement. Surfaces the read on entity detail pages, the marker tooltip, the bullseye detail panel (intelligence note count + latest activity), the engagement landing's "Latest from Stout" feed, and the filterable browse view.
