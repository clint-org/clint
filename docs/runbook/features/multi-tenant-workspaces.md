...
- Each **space** within a tenant is a firewalled engagement scoped to a domain (a therapy area, asset class, client team) — pipelines, events, and portfolio reads all live inside, with their own members and data
