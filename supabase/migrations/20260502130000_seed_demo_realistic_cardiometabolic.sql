...
-- =============================================================================
-- 12. helper: _seed_demo_primary_intelligence (10 reads, security definer)
-- =============================================================================
-- Runs as security definer so the orchestrator's space-owner gate is the
-- authoritative permission check; bypasses the agency-only write RLS that
-- would otherwise block space owners who are not also agency members.
-- (Existing pattern from migration 20260501132002.)
...
begin
  ...
  insert into public.primary_intelligence (
    ...
    E'- Lilly sNDA filing timing for HFpEF\n- ESC and AHA late-breaker positioning\n- Payer language on whether tirzepatide HFpEF coverage moves under cardiology benefit vs metabolic\n- Tracking finerenone (FINEARTS-HF) and any combo-therapy framing in updated HF guidelines',
  ...
  insert into public.primary_intelligence (
    ...
    E'- Novo R&D day language on amycretin and other combination programs\n- REDEFINE-2 readout (T2D + obesity) for confirmation or further pressure\n- Payer access decisions on CagriSema vs incumbent semaglutide\n- Lilly retatrutide TRIUMPH-1 readout as the next-class anchor',
  ...
  insert into public.primary_intelligence (
    ...
    E'- PDUFA date and label language on REMS / echo monitoring requirements\n- Cytokinetics commercial buildout and KOL coverage\n- Camzyos formulary defenses (rebates, REMS-burden positioning)\n- MAPLE-HCM readout against metoprolol as the next big differentiator',
  ...
  insert into public.primary_intelligence (
    ...
    E'- Bayer commercial mobilization on finerenone HFpEF label\n- ESC and ACC guideline language post-readout\n- Combination trials testing SGLT2 + finerenone or SGLT2 + tirzepatide HFpEF stacks\n- Generic Entresto displacement dynamics in HFrEF, where finerenone is a separate consideration',
  ...
  insert into public.primary_intelligence (
    ...
    E'- Specific Big Pharma BD language on Viking (Lilly, Pfizer, Roche signals)\n- VK2735 oral P2 readout for platform validation\n- P3 trial design announcements that lock in regulatory path\n- Manufacturing partnership or scale-up disclosures',
  ...
  insert into public.primary_intelligence (
    ...
    E'- BridgeBio commercial buildout language and KOL coverage of switching evidence\n- Pfizer Vyndaqel defense (rebates, real-world data submissions, generic-defense posture)\n- Any post-hoc subgroup signals favoring acoramidis (high-mortality patients, advanced disease)\n- LOE proximity for Vyndaqel composition-of-matter patents',
  ...
  insert into public.primary_intelligence (
    ...
    E'- Pfizer R&D investor day language on cardiometabolic priority\n- Lilly orforglipron tolerability profile in P3 vs danuglipron P2 footprint\n- AZ AZD5004 development pace; whether this accelerates or stalls post-Pfizer signal\n- Any inbound BD discussions for orforglipron or AZD5004 as Pfizer-style insurance bets',
  ...
  insert into public.primary_intelligence (
    ...
    E'- Conference late-breaker calendars (ADA, ESC, AHA, ObesityWeek) for sequencing and platform allocation\n- Lilly investor day messaging on portfolio prioritization between orforglipron and retatrutide\n- Aficamten launch readiness and launch-pricing language\n- Any pre-announcement or topline staggering by sponsors',
  ...
  insert into public.primary_intelligence (
    ...
    E'- Lilly investor messaging in the 2-3 weeks before topline\n- Any Lilly sNDA strategy commentary that hints at confidence level\n- AZD5004 pace as a downside-case tracker',
    E'',
  ...
  insert into public.primary_intelligence (
    ...
    E'- Amgen P3 program design and dose selection\n- KOL commentary on long-term GIPR pathway biology\n- Whether other sponsors pivot to GIPR antagonism in pipeline announcements',
    E'',
