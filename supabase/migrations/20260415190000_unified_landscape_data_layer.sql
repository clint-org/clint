-- migration: 20260415190000_unified_landscape_data_layer
-- purpose: add category_id to get_dashboard_data marker_type output and drop
--          get_key_catalysts RPC (catalysts now derived client-side from dashboard data).
-- affected functions:
--   public.get_dashboard_data  -- adds category_id to marker_type jsonb
--   public.get_key_catalysts   -- dropped (no longer used)

-- =============================================================================
-- 1. update get_dashboard_data: add category_id to marker_type object
-- =============================================================================
...
-- =============================================================================
-- 2. drop get_key_catalysts (catalysts now derived client-side)
-- =============================================================================
