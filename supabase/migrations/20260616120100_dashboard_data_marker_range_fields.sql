-- Expose marker end_date_precision + is_ongoing via get_dashboard_data so the
-- timeline can render fuzzy / open-ended marker ranges (P2.1 ext). Function
-- body reproduced verbatim from 20260615131000_dashboard_data_marker_precision
-- with two added fields in the markers jsonb projection; nothing else changed.
