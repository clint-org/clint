-- migration: 20260416120000_fix_positioning_trial_phases
-- purpose: fix get_positioning_data to use trials.phase_type instead of the
--          dropped trial_phases table. The 20260415170000 migration rewrote
--          this function but used the old trial_phases join.
-- affected functions: public.get_positioning_data
