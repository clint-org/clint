                    ...
                    <li class="border-b border-slate-100 py-1.5 last:border-b-0">
                      ...
                      >
                        <div class="min-w-0 flex-1">
                          <div class="flex items-center gap-2 text-[10px] font-mono uppercase tracking-wide text-slate-500">
                            <span
                              class="font-semibold"
                      ...
                      @if (isRowExpanded(row.id)) {
                        <div class="mt-2 grid grid-cols-2 gap-2">
                          <div>
                            ...
                            <pre class="overflow-x-auto rounded bg-slate-50 p-2 text-[10px] text-slate-700">{{
                              row.old_values | json
                            }}</pre>
                          </div>
                          <div>
