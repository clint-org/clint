  ...
  template: `
    <form (ngSubmit)="onSubmit()" class="space-y-4">
      <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
        <div>
          <label for="marker-type" class="block text-sm font-medium text-gray-700">
            Marker Type
          </label>
          <select
            id="marker-type"
        ...
        <div>
          <label for="marker-event-date" class="block text-sm font-medium text-gray-700">
            Event Date
          </label>
          <input
        ...
        <div>
          <label for="marker-end-date" class="block text-sm font-medium text-gray-700">
            End Date
          </label>
          <input
            id="marker-end-date"
        ...
        <div>
          <label for="marker-tooltip" class="block text-sm font-medium text-gray-700">
            Tooltip Text
          </label>
          <input
            id="marker-tooltip"
        ...
        <div>
          <label for="marker-tooltip-image" class="block text-sm font-medium text-gray-700">
            Tooltip Image URL
          </label>
          <input
        ...
        <div class="flex items-center pt-6">
          ...
          />
          <label for="marker-projected" class="ml-2 text-sm text-gray-700">
            Is Projected
          </label>
        </div>
      </div>
