    ...
    <app-manage-page-shell>
      ...
      @if (currentUserIsOwner()) {
        <div class="mt-12 max-w-xl border-t border-slate-200 pt-6">
          ...
          <p class="mt-1 text-[11px] text-slate-500">
            Per-tenant caps applied to every space material upload. Files exceeding the size limit
            or using a mime type outside the allowlist are rejected by the server.
          </p>
      ...
      @if (currentUserIsOwner()) {
        <div class="mt-12 max-w-xl border-t border-slate-200 pt-6">
          ...
          <div class="mt-4 space-y-4">
            <div class="flex items-center gap-3">
              <p-toggleSwitch [ngModel]="aiEnabled()" (ngModelChange)="onAiEnabledToggle($event)" />
